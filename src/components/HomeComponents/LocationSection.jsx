...
export default function LocationSection() {
  ...
  const mapDirectLink = "https://www.google.com/maps/place/Catleya+Royal+Club/@4.865946,-75.7478597,17z/data=!3m1!4b1!4m6!3m5!1s0x8e387f70e4a9d1f3:0xfdba7186374b0adf!8m2!3d4.865946!4d-75.7452848!16s%2Fg%2F11ym12d_5n?entry=ttu&g_ep=EgoyMDI2MDExMy4wIKXMDSoASAFQAw%3D%3D";

  return (
    <section
      className="bg-white pb-24 px-4"
      itemScope
      ...
      <div className="container mx-auto max-w-[1200px]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 space-y-8">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <MapPin className="w-5 h-5 text-[#476d15]" aria-hidden="true" />
                <span className="text-sm font-bold tracking-[0.2em] text-[#476d15] uppercase">
                  Ubicación
                </span>
              </div>
              <h2
                className="text-4xl font-serif text-[#2c4549] leading-tight"
                itemProp="name"
              >
                Vereda Pénjamo, <br />
            ...
            >
              Situado en el corazón de Combia, una zona reconocida por su clima
              privilegiado y su vocación cafetera. Estamos en un punto
              estratégico que combina la paz del campo con un acceso rápido a la
            ...
            >
              ...
              <meta itemProp="addressRegion" content="Risaralda" />
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    A solo 25 minutos del Aeropuerto Internacional Matecaña
                    (PEI).
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    A 20 minutos del centro de Pereira y cerca de las
                    principales rutas gastronómicas de Combia.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 h-[450px] md:h-[550px] w-full relative">
            <div className="absolute inset-0 bg-[#476d15]/5 -rotate-1 rounded-2xl pointer-events-none"></div>
            <div className="relative h-full w-full overflow-hidden rounded-xl shadow-2xl border border-gray-100">
              <iframe
                ...
                title="Mapa de ubicación Catleya Royal Club en Pereira"
              ></iframe>
            </div>
          </div>
        </div>
